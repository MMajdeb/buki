...
<asp:Content ID="Header1" ContentPlaceHolderID="HeaderPlaceHolder1" runat="Server">
	...
	<style type="text/css">
		...
		.buttonRemove
		{
			background-image: url('images/led-icons/cancel.gif');
			float: left;
			display: none;
		}
		.buttonAdd
		{
			background-image: url('images/led-icons/add.png');
		}
		.buttonEdit
		{
			background-image: url('images/led-icons/pencil.gif');
			float: left;
			display: none;
		}
		.buttonTime
		{
			background-image: url('images/led-icons/clock.gif');
			float: left;
			display: none;
		}
		.inputHeaderText
		...
		.buttonAccept
		{
			background-image: url('images/led-icons/accept.gif');
			float: right;
			display: none;
		}
		.fitBox
		...
		<div id="fullwidth">
			<div class="fullwidth">
				...
				<div>
					הוראות הפעלה:
					<br />
					רשום את שם העמדה בתוך תיבת הרשימה, לאחר מכן שמות העמדות ישתנו בהתאם. משוך/גרור את
					אחת מהצורות לתוך המלבן משטח העבודה והיא תתווסף לתוך המלבן. מקם את הצורה ע"י גרירת
					הצורה. שנה את גודל הצורה בעזרת גרירת המשולש הקטן בתחתית הצורה. להגדלת משטח העבודה
					משוך את הצורה כלפי מטה או לצד ימין והמשטח יגדל. להסרת עמדה עלה עם העכבר על הצורה
					ולחץ על כפתור סגירה ליד הצורה שהתווספה
				</div>
				<br />
				<%--<table border="0">
				    <tr>
				...
				<div id="divContainer" dir="ltr" style="border: solid 1px red; height: 450px; clear: both;
					margin: 0px; padding: 0px; width: auto; overflow: scroll; position: relative;">
				...
				<div id="addDialog" style="font: 70% 'Trebuchet MS', sans-serif; margin: 50px;" title="הוסף אירוע">
					<table cellpadding="0" class="style1">
						<tr>
							<td class="alignLeft">
								שם:
