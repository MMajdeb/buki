				...
				<table border="0">
				    <tr>
						...
						<td class="formvalue">
							...
							<asp:RequiredFieldValidator ID="ddlCategoryRequiredFieldValidator1" runat="server" ErrorMessage="אנא בחר קטגוריה שהעסק שלכם משתייך." ControlToValidate="ddlCategory" InitialValue="-1"  SetFocusOnError="true"></asp:RequiredFieldValidator>
						</td>
					</tr>
					<tr>
						<td class="formlabel">
