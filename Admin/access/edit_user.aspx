...
<script runat="server">
    ...
    {
        user.ChangePassword(user.ResetPassword(), "password1");
        UserUpdateMessage.Text = "user:" + user.UserName + " password reset to 'password1'";
    }
</script>
...
&nbsp;&nbsp;&nbsp;
<asp:Button ID="btnReset" runat="server" Text="Reset passwod" 
        OnClientClick="return confirm('Click OK to reset password this user.')" 
        onclick="btnReset_Click" />        
&nbsp;&nbsp;&nbsp;
<asp:Button ID="Button2" runat="server" Text="Delete User" OnClick="DeleteUser" OnClientClick="return confirm('Are Your Sure?')" />
<div>user password after reset password is 'password1'</div>
</div>
